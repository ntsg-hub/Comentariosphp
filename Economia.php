...
<?php
                ...
                try {
                    ...
                    if(!empty($_POST)){
                        ...
                        $texto = $_POST['texto'];
                        $fecha=date("y/m/d");
                        $conexion->query("INSERT INTO `tema2` (`id`, `nombre`, `comentario`, `fecha`) VALUES (NULL, '$nom', '$texto','$fecha' );");
                ...
                $busca = $conexion->query("SELECT * FROM `tema2` ORDER BY id DESC");
